...
var decodePayloadTests = []decodePayloadTest{
	...
	},
	{
		...
		payload: []byte{
			0x02, 0x00, 0x04, 0x00, 0x06, 0x08, 0x01, 0x00,
	...
	},
	{
		...
		payload: []byte{
			0x04, 0x00, 0x06, 0x08, 0x01, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00,
		},
		expErr: hop.ErrInvalidPayload{
			Type:      record.AmtOnionType,
	...
	},
	{
		...
		payload: []byte{
			0x02, 0x00, 0x06, 0x08, 0x01, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00,
		},
		expErr: hop.ErrInvalidPayload{
			Type:      record.LockTimeOnionType,
	...
	},
	{
		...
		payload: []byte{
			0x02, 0x00, 0x04, 0x00, 0x06, 0x08, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		},
		expErr: hop.ErrInvalidPayload{
	...
	},
	{
		...
		payload: []byte{
			0x00, 0x00, 0x02, 0x00, 0x04, 0x00, 0x06, 0x08,
