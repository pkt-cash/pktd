...
func TestBtcdExtCmds(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			unmarhsaled: &btcjson.DebugLevelCmd{
				LevelSpec: "trace",
			},
		},
		{
		...
		},
		{
			...
			unmarhsaled: &btcjson.GenerateCmd{
				NumBlocks: 1,
			},
		},
		{
			...
			unmarhsaled: &btcjson.GetBestBlockCmd{},
		},
		{
			name: "getcurrentnet",
			newCmd: func() (interface{}, er.R) {
			...
			unmarhsaled: &btcjson.GetCurrentNetCmd{},
		},
		{
			name: "getheaders",
			newCmd: func() (interface{}, er.R) {
			...
			unmarhsaled: &btcjson.GetHeadersCmd{
		...
		},
		{
			...
			unmarhsaled: &btcjson.VersionCmd{},
		},
	}
