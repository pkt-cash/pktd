...
// assigned on unmarhsaled commands.
func TestChainSvrCmds(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			unmarhsaled: &btcjson.AddNodeCmd{Addr: "127.0.0.1", SubCmd: btcjson.ANRemove},
		},
		{
			...
			unmarhsaled: &btcjson.CreateRawTransactionCmd{
...

		{
			...
			unmarhsaled: &btcjson.DecodeRawTransactionCmd{HexTx: "123"},
		},
		{
			name: "decodescript",
			newCmd: func() (interface{}, er.R) {
			...
			unmarhsaled: &btcjson.DecodeScriptCmd{HexScript: "00"},
		},
		{
			...
			unmarhsaled: &btcjson.GetAddedNodeInfoCmd{DNS: true, Node: nil},
		},
		{
			...
			unmarhsaled: &btcjson.GetAddedNodeInfoCmd{
				DNS:  true,
		...
		},
		{
			...
			unmarhsaled: &btcjson.GetBestBlockHashCmd{},
		},
		{
			name: "getblock",
			newCmd: func() (interface{}, er.R) {
			...
			unmarhsaled: &btcjson.GetBlockCmd{
				Hash:       "123",
		...
		},
		{
			...
			unmarhsaled: &btcjson.GetBlockChainInfoCmd{},
		},
		{
			name: "getblockcount",
			newCmd: func() (interface{}, er.R) {
			...
			unmarhsaled: &btcjson.GetBlockCountCmd{},
		},
		{
			name: "getblockhash",
			newCmd: func() (interface{}, er.R) {
			...
			unmarhsaled: &btcjson.GetBlockHashCmd{Index: 123},
		},
		{
			name: "getblockheader",
			newCmd: func() (interface{}, er.R) {
			...
			unmarhsaled: &btcjson.GetBlockHeaderCmd{
				Hash:    "123",
				Verbose: btcjson.Bool(true),
			},
		},
		{
			...
			unmarhsaled: &btcjson.GetBlockTemplateCmd{Request: nil},
		},
		{
			...
			unmarhsaled: &btcjson.GetBlockTemplateCmd{
		...
		},
		{
			...
			unmarhsaled: &btcjson.GetCFilterCmd{
				Hash:       "123",
		...
		},
		{
			...
			unmarhsaled: &btcjson.GetCFilterHeaderCmd{
				Hash:       "123",
				FilterType: wire.GCSFilterRegular,
			},
		},
		{
			...
			unmarhsaled: &btcjson.GetChainTipsCmd{},
		},
		{
			...
			unmarhsaled: &btcjson.GetConnectionCountCmd{},
		},
		{
			name: "getdifficulty",
			newCmd: func() (interface{}, er.R) {
			...
			unmarhsaled: &btcjson.GetDifficultyCmd{},
		},
		{
			name: "getgenerate",
			newCmd: func() (interface{}, er.R) {
			...
			unmarhsaled: &btcjson.GetGenerateCmd{},
		},
		{
			...
			unmarhsaled: &btcjson.GetHashesPerSecCmd{},
		},
		{
			name: "getinfo",
			newCmd: func() (interface{}, er.R) {
			...
			unmarhsaled: &btcjson.GetInfoCmd{},
		},
		{
			...
			unmarhsaled: &btcjson.GetMempoolEntryCmd{
				TxID: "txhash",
			},
		},
		{
			...
			unmarhsaled: &btcjson.GetMempoolInfoCmd{},
		},
		{
			name: "getmininginfo",
			newCmd: func() (interface{}, er.R) {
			...
			unmarhsaled: &btcjson.GetMiningInfoCmd{},
		},
		{
			name: "getnetworkinfo",
			newCmd: func() (interface{}, er.R) {
			...
			unmarhsaled: &btcjson.GetNetworkInfoCmd{},
		},
		{
			name: "getnettotals",
			newCmd: func() (interface{}, er.R) {
			...
			unmarhsaled: &btcjson.GetNetTotalsCmd{},
		},
		{
			...
			unmarhsaled: &btcjson.GetNetworkHashPSCmd{
		...
		},
		{
			...
			unmarhsaled: &btcjson.GetPeerInfoCmd{},
		},
		{
			name: "getrawmempool",
			newCmd: func() (interface{}, er.R) {
			...
			unmarhsaled: &btcjson.GetRawMempoolCmd{
		...
		},
		{
			...
			unmarhsaled: &btcjson.GetRawTransactionCmd{
				Txid:    "123",
				Verbose: btcjson.Bool(false),
			},
		},
		...
		},
		{
			...
			unmarhsaled: &btcjson.GetTxOutCmd{
				Txid:           "123",
				Vout:           1,
		...
		},
		{
			...
			unmarhsaled: &btcjson.GetTxOutProofCmd{
		...
		},
		{
			...
			unmarhsaled: &btcjson.GetTxOutSetInfoCmd{},
		},
		{
			name: "getwork",
			newCmd: func() (interface{}, er.R) {
			...
			unmarhsaled: &btcjson.GetWorkCmd{
				Data: nil,
			},
		},
		{
		...
		},
		{
			...
			unmarhsaled: &btcjson.InvalidateBlockCmd{
				BlockHash: "123",
			},
		},
		{
		...
		},
		{
			...
			unmarhsaled: &btcjson.PreciousBlockCmd{
				BlockHash: "0123",
			},
		},
		{
			...
			unmarhsaled: &btcjson.ReconsiderBlockCmd{
				BlockHash: "123",
			},
		},
		{
			...
			unmarhsaled: &btcjson.SearchRawTransactionsCmd{
				Address:     "1Address",
		...
		},
		{
			...
			unmarhsaled: &btcjson.SendRawTransactionCmd{
				HexTx:         "1122",
		...
		},
		{
			...
			unmarhsaled: &btcjson.SetGenerateCmd{
				Generate:     true,
		...
		},
		{
			...
			unmarhsaled: &btcjson.SubmitBlockCmd{
				HexBlock: "112233",
				Options:  nil,
			},
		},
		...
		},
		{
			...
			unmarhsaled: &btcjson.ValidateAddressCmd{
				Address: "1Address",
			},
		},
		{
			...
			unmarhsaled: &btcjson.VerifyChainCmd{
		...
		},
		{
			...
			unmarhsaled: &btcjson.VerifyMessageCmd{
				Address:   "1Address",
				Signature: "301234",
				Message:   "test",
			},
		},
		{
			...
			unmarhsaled: &btcjson.VerifyTxOutProofCmd{
				Proof: "test",
			},
		},
	}
	...
	for i, test := range tests {
		...
		if !reflect.DeepEqual(cmd, test.unmarhsaled) {
			t.Errorf("Test #%d (%s) unexpected unmarhsaled command "+
...
/*func TestChainSvrCmdErrors(t *testing.T) {
	...
	/*t.Logf("Running %d tests", len(tests))
	for i, test := range tests {
		err := er.E(jsoniter.Unmarshal([]byte(test.marhsaled), &test.result))
